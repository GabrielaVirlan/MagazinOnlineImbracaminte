...
namespace MagazinOnlineImbracaminte.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MagazinOnlineImbracaminteContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,InStock,Price,Image,QuantityInStock,Quantities")] Product product)
        {
