...
namespace MagazinOnlineImbracaminte.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(MagazinOnlineImbracaminteContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("RoleId,Name,Id,NormalizedName,ConcurrencyStamp")] Role role)
        {
            if (id != role.Id)
            {
                return NotFound();
